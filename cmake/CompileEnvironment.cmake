...
elseif(CMAKE_SYSTEM_NAME STREQUAL "AIX")
    ...
    message(STATUS "Unsupported Target OS: ${CMAKE_SYSTEM_NAME}")
endif()
...
if(CMAKE_C_COMPILER_ID MATCHES Intel)
    ...
    message(STATUS "Target C Compiler: Intel")
elseif (CMAKE_C_COMPILER_ID MATCHES GNU)
    add_compile_definitions(IS_GNU_C_COMPILER)
    message(STATUS "Target C Compiler: GNU")
elseif (CMAKE_C_COMPILER_ID MATCHES PGI)
    add_compile_definitions(IS_PGI_C_COMPILER)
    message(STATUS "Target C Compiler: PGI")
elseif (CMAKE_C_COMPILER_ID MATCHES XL)
    add_compile_definitions(IS_XL_C_COMPILER)
    message(STATUS "Target C Compiler: XL")
else()
...
elseif(CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "AMD64")
    ...
    add_compile_definitions(IS_CPU_X86_64)
    add_compile_definitions(IS_CPU_AMD64)
